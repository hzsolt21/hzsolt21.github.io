...
To setup up your local vm, try Metasploitable 3 [Metasploitable3](https://github.com/rapid7/metasploitable3)
I will go with the Metasploitable for now. For the EternalBlue to work I had to disable the firewall on metasploitable3.
Metasploitable IP: 10.0.2.15

Attacker
There are a few things you need to set up on your attacker machine (Kali Linux in my case) too. First install pip, then impacket using the commands listed below. Attacker IP: 10.0.2.4
```
sudo apt-get update
...
```
<br>
You will find the exploit 42315.py
